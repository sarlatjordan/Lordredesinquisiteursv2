...
| Sécurité RLS | 0 | 2 | **2** |
| Performance | 1 | 3 | **4** |
| Cohérence patterns | 1 | 2 | **3** |
| Code mort / qualité | 0 | 1 | **1** |
| **Total** | **6** | **15** | **21** |
...
### [MOYEN] `components/chat/chat-layout.tsx:110`
...
### [FAIBLE] `actions/hangar-sync.ts:419`
...
### [FAIBLE] `components/ui/calendar.tsx:91`
...
### [MOYEN] `actions/notifications.ts` — `markRead`, `markAllRead`
...
### [MOYEN] `actions/onboarding.ts` — `claimOnboardingStep`
...
### [FAIBLE] `actions/notifications.ts` — `createAdminClient` dans `markRead`
...
### [FAIBLE] `supabase/migrations/006_gallery.sql:22-33`
...
### [FAIBLE] `supabase/migrations/001_initial.sql` — Policies legacy `admin`/`officer`
...
### [MOYEN] `app/(app)/membres/page.tsx:22-34`
...
### [FAIBLE] `app/(app)/admin/activite/page.tsx`, `admin/avatars/page.tsx`, `admin/points/page.tsx`
...
### [FAIBLE] `app/(app)/evenements/page.tsx:14-29`
...
### [MOYEN] `actions/applications.ts:83` — `console.error` sans guard `NODE_ENV`
...
### [FAIBLE] `app/(app)/mfa/page.tsx` — `export const dynamic` manquant
...
### [FAIBLE] `actions/members.ts` — `updateMemberRole` séquentialité interne
...
### [FAIBLE] `actions/hangar-sync.ts:443` — Message d'erreur trompeur
